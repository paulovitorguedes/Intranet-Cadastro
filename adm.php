							...
							<table class="corpoIntranet">
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_servidor" id="iSlcServidor" 
										onchange="buscarCadastroServidor(this.value, document.getElementById('iNomeLojaServidor').value,
							...
							<table class="corpoIntranet">
								...
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_GatewayE1" id="iSlcGatewayE1" 
										onchange="buscarCadastroGateway(this.value, document.getElementById('iNomeLojaGateway').value,
								...
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_GatewayFxs" id="iSlcGatewayFxs"
										onchange="buscarCadastroGateway(this.value, document.getElementById('iNomeLojaGateway').value,
								...
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_GatewayFxo" id="iSlcGatewayFxo"
										onchange="buscarCadastroGateway(this.value, document.getElementById('iNomeLojaGateway').value,
								...
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_GatewayGsm" id="iSlcGatewayGsm"
										onchange="buscarCadastroGateway(this.value, document.getElementById('iNomeLojaGateway').value,
							...
							<table class="corpoIntranet">
								<tr>
									...
									<td> 
										...
										<select style="display:block" name="slc_OutrosAcessos" id="iSlcOutrosAcessos"
										onchange="buscarCadastroOutrosAcessos(this.value, document.getElementById('iNomeLojaOutrosAcessos').value,
